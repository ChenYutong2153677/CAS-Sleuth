...
const downloadClicked = () => {
  ...
  //       console.log(exportData.value[i])
  //       iframe.herf = exportData.value[i]
  //       iframe.target = '_blank'; // 打开新窗口/标签页下载
  //       iframe.download = 'yourfile.pdf'; // 下载的文件名
  ...
  //   link.href = 'http://43.133.192.56:5555///virus-to-excel?virus_id='+virus_id.value; // 替换为实际文件的URL
  //     link.target = '_blank'; // 打开新窗口/标签页下载
  //     link.download = 'yourfile.pdf'; // 下载的文件名
  ...
  // else if(isChecked2.value===true){
  //   const link = document.createElement('a');
  //     link.href = 'http://43.133.192.56:5555//cas-to-excel?type='+type.value+'&virus_id='+virus_id.value; // 替换为实际文件的URL
  //     link.target = '_blank'; // 打开新窗口/标签页下载
  //     link.download = 'yourfile.pdf'; // 下载的文件名
